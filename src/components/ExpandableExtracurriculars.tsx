...
const desc4 = "During my IT Internship at the New Albany-Plain Local School District, I worked with the district’s technology department to help maintain and manage hundreds of student and staff devices. My role involved setting up, imaging, and troubleshooting laptops and Chromebooks, organizing device inventory, and assisting with software updates and network setup across multiple school buildings. Through this hands-on experience, I gained valuable technical and professional skills, including diagnosing hardware and software issues, improving efficiency in tech workflows, and providing clear communication and support to both students and staff."
